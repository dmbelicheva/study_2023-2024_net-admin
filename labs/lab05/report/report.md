...
Теперь настроем msk-donskaya-dmbelicheva-sw-1 как VTP-сервер:
...
Настроем msk-donskaya-dmbelicheva-sw-2 как VTP-клиент:

![Конфигурация VTP msk-donskaya-dmbelicheva-sw-2](image/10.png){#fig:001 width=70%}

Настроем msk-donskaya-dmbelicheva-sw-3 как VTP-клиент:

![Конфигурация VTP msk-donskaya-dmbelicheva-sw-3](image/11.png){#fig:001 width=70%}

Настроем msk-donskaya-dmbelicheva-sw-4 как VTP-клиент:
...
Настроем msk-pavlovskaya-dmbelicheva-sw-1 как VTP-клиент:
...
| msk-donskaya-dmbelicheva-sw-2    | g0/1        | msk-donskaya-sw-1    |             | 2, 3                     |
|                                  | g0/2        | msk-donskaya-sw-3    |             | 2, 3                     |
|                                  | f0/1        | Web-server           | 3           |                          |
|                                  | f0/2        | File-server          | 3           |                          |
| msk-donskaya-dmbelicheva-sw-3    | g0/1        | msk-donskaya-sw-2    |             | 2, 3                     |
|                                  | f0/1        | Mail-server          | 3           |                          |
|                                  | f0/2        | Dns-server           | 3           |                          |
| msk-donskaya-dmbelicheva-sw-4    | g0/1        | msk-donskaya-sw-1    |             | 2, 101, 102, 103, 104    |
|                                  | f0/1–f0/5   | dk                   | 101         |                          |
|                                  | f0/6–f0/10  | departments          | 102         |                          |
|                                  | f0/11–f0/15 | adm                  | 103         |                          |
|                                  | f0/16–f0/24 | other                | 104         |                          |
| msk-pavlovskaya-dmbelicheva-sw-1 | f0/24       | msk-donskaya-sw-1    |             | 2, 101, 104              |
|                                  | f0/1–f0/15  | dk                   | 101         |                          |
|                                  | f0/20       | other                | 104         |                          | 
...
Далее выполним проверку нашей настройке устройств и пропингуем dk-pavlovskaya-dmbelicheva-1 с dk-donskaya-dmbelicheva-1.
...
Но если мы попробуем с dk-donskaya-dmbelicheva-1 пропинговать dk-pavlovskaya-dmbelicheva-1, который находиться в другом VLAN, у нас ничего не получится.
