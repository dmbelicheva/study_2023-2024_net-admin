...
Откроем терминал dep-donskaya-dmbelicheva-1 и пропингуем разные устройства (рис.[-@fig:022]). Увидим, что серверы и другие оконечные устройства пингуются, однако к сетевому оборудованию доступа нет, как и должно быть.

![Пингование устройств с dep-donskaya-dmbelicheva-1](image/19.png){#fig:022 width=70%}
...
![Проверка доступности устройств с dk-donskaya-dmbelicheva-1](image/20.png){#fig:023 width=70%}
...
![Проверка доступности устройств с dk-donskaya-dmbelicheva-1](image/21.png){#fig:024 width=70%}
